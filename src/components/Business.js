...
class News extends React.Component {
    ...
    componentDidMount() {
        Axios.get('https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=05c0f32f4c0e416f87473d04dc80ed67').then((res) => {
    ...
    render() {
        ...
        <div>
            <div className="Wrappp">
                ...
                <div class="heading">
                    <h2> TOP HEADLINES IN BUSINESS </h2>
                </div>
